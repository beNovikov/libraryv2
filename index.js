...
function createBookDOM(book) {
  ...
  /* Create DOM element for each of book's value (title, author, etc.) */
  ...
  isReadDOM.textContent = isRead === true ? 'I have read that book!' : "I haven't read that book, yet!";
  let markReadDOM = document.createElement("a");
  markReadDOM.classList.add("mark-read");
  isRead ? markReadDOM.classList.add("unread") : markReadDOM.classList.add("read");
